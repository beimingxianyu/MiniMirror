...
#define GET_TEXTURE2D(variable_name) __SAMPLER_TEXTURE2D_VECTOR_NAME__[__CONSTANT_VARIABLE_NAME__.GET_TEXTURE2D(variable_name)]

#define GET_TEXTURE3D(varable_name) __SAMPLER_TEXTURE3D_VECTOR_NAME__[__CONSTANT_VARIABLE_NAME__.GET_TEXTURE3D(variable_name)]

#define GET_TEXTURECUBE(varable_name) __SAMPLER_TEXTURECUBE_VECTOR_NAME__[__CONSTANT_VARIABLE_NAME__.GET_TEXTURE3D(variable_name)]

#define GET_STORAGE_TEXTURE2D(variable_name) __STORAGE_TEXTURE2D_VECTOR_NAME__[__CONSTANT_VARIABLE_NAME__.GET_STORAGE_TEXTURE2D_NAME(varable_name)]

#define GET_STORAGE_TEXTURE3D(variable_name) __STORAGE_TEXTURE3D_VECTOR_NAME__[__CONSTANT_VARIABLE_NAME__.GET_STORAGE_TEXTURE3D_NAME(varable_name)]

#define GET_STORAGE_TEXTURECUBE(variable_name) __STORAGE_TEXTURECUBE_VECTOR_NAME__[__CONSTANT_VARIABLE_NAME__.GET_STORAGE_TEXTURECUBE_NAME(varable_name)]
