...
#define GET_UNIFORM_BUFFER(variable_name) __CONSTANT_VARIABLE_NAME__.GET_UNIFORM_BUFFER_NAME(variable_name)

#define GET_STORAGE_BUFFER(variable_name) __CONSTANT_VARIABLE_NAME__.GET_STORAGE_BUFFER_NAME(variable_name)
