...
enum class ShaderType { GRAPHICS, COMPUTE, RAY };
...
enum class ShaderSlotCount : std::uint64_t {
  // GRAPHICS
  SHADER_STAGE_VERTEX_0_SLOT_BIT = (0x1 << 0) + 0x0,
  SHADER_STAGE_VERTEX_1_SLOT_BIT = (0x1 << 0) + 0x1,
  SHADER_STAGE_VERTEX_2_SLOT_BIT = (0x1 << 0) + 0x2,
  SHADER_STAGE_VERTEX_3_SLOT_BIT = (0x1 << 0) + 0x3,
  SHADER_STAGE_VERTEX_4_SLOT_BIT = (0x1 << 0) + 0x4,
  SHADER_STAGE_VERTEX_5_SLOT_BIT = (0x1 << 0) + 0x5,
  SHADER_STAGE_VERTEX_6_SLOT_BIT = (0x1 << 0) + 0x6,
  SHADER_STAGE_VERTEX_7_SLOT_BIT = (0x1 << 0) + 0x7,
  SHADER_STAGE_VERTEX_8_SLOT_BIT = (0x1 << 0) + 0x8,
  SHADER_STAGE_VERTEX_9_SLOT_BIT = (0x1 << 0) + 0x9,
  SHADER_STAGE_VERTEX_10_SLOT_BIT = (0x1 << 0) + 0xA,
  SHADER_STAGE_VERTEX_11_SLOT_BIT = (0x1 << 0) + 0xB,
  SHADER_STAGE_VERTEX_12_SLOT_BIT = (0x1 << 0) + 0xC,
  SHADER_STAGE_VERTEX_13_SLOT_BIT = (0x1 << 0) + 0xD,
  SHADER_STAGE_VERTEX_14_SLOT_BIT = (0x1 << 0) + 0xE,
  SHADER_STAGE_VERTEX_15_SLOT_BIT = (0x1 << 0) + 0xF,
  SHADER_STAGE_VERTEX_16_SLOT_BIT = (0x1 << 0) + 0x10,
  SHADER_STAGE_TESSELLATION_CONTROL_0_SLOT_BIT = (0x1 << 5) + 0x0,
  SHADER_STAGE_TESSELLATION_CONTROL_1_SLOT_BIT = (0x1 << 5) + 0x1,
  SHADER_STAGE_TESSELLATION_CONTROL_2_SLOT_BIT = (0x1 << 5) + 0x2,
  SHADER_STAGE_TESSELLATION_CONTROL_3_SLOT_BIT = (0x1 << 5) + 0x3,
  SHADER_STAGE_TESSELLATION_CONTROL_4_SLOT_BIT = (0x1 << 5) + 0x4,
  SHADER_STAGE_TESSELLATION_CONTROL_5_SLOT_BIT = (0x1 << 5) + 0x5,
  SHADER_STAGE_TESSELLATION_CONTROL_6_SLOT_BIT = (0x1 << 5) + 0x6,
  SHADER_STAGE_TESSELLATION_CONTROL_7_SLOT_BIT = (0x1 << 5) + 0x7,
  SHADER_STAGE_TESSELLATION_CONTROL_8_SLOT_BIT = (0x1 << 5) + 0x8,
  SHADER_STAGE_TESSELLATION_CONTROL_9_SLOT_BIT = (0x1 << 5) + 0x9,
  SHADER_STAGE_TESSELLATION_CONTROL_10_SLOT_BIT = (0x1 << 5) + 0xA,
  SHADER_STAGE_TESSELLATION_CONTROL_11_SLOT_BIT = (0x1 << 5) + 0xB,
  SHADER_STAGE_TESSELLATION_CONTROL_12_SLOT_BIT = (0x1 << 5) + 0xC,
  SHADER_STAGE_TESSELLATION_CONTROL_13_SLOT_BIT = (0x1 << 5) + 0xD,
  SHADER_STAGE_TESSELLATION_CONTROL_14_SLOT_BIT = (0x1 << 5) + 0xE,
  SHADER_STAGE_TESSELLATION_CONTROL_15_SLOT_BIT = (0x1 << 5) + 0xF,
  SHADER_STAGE_TESSELLATION_CONTROL_16_SLOT_BIT = (0x1 << 5) + 0x10,
  SHADER_STAGE_TESSELLATION_EVALUATION_0_SLOT_BIT = (0x1 << 10) + 0x0,
  SHADER_STAGE_TESSELLATION_EVALUATION_1_SLOT_BIT = (0x1 << 10) + 0x1,
  SHADER_STAGE_TESSELLATION_EVALUATION_2_SLOT_BIT = (0x1 << 10) + 0x2,
  SHADER_STAGE_TESSELLATION_EVALUATION_3_SLOT_BIT = (0x1 << 10) + 0x3,
  SHADER_STAGE_TESSELLATION_EVALUATION_4_SLOT_BIT = (0x1 << 10) + 0x4,
  SHADER_STAGE_TESSELLATION_EVALUATION_5_SLOT_BIT = (0x1 << 10) + 0x5,
  SHADER_STAGE_TESSELLATION_EVALUATION_6_SLOT_BIT = (0x1 << 10) + 0x6,
  SHADER_STAGE_TESSELLATION_EVALUATION_7_SLOT_BIT = (0x1 << 10) + 0x7,
  SHADER_STAGE_TESSELLATION_EVALUATION_8_SLOT_BIT = (0x1 << 10) + 0x8,
  SHADER_STAGE_TESSELLATION_EVALUATION_9_SLOT_BIT = (0x1 << 10) + 0x9,
  SHADER_STAGE_TESSELLATION_EVALUATION_10_SLOT_BIT = (0x1 << 10) + 0xA,
  SHADER_STAGE_TESSELLATION_EVALUATION_11_SLOT_BIT = (0x1 << 10) + 0xB,
  SHADER_STAGE_TESSELLATION_EVALUATION_12_SLOT_BIT = (0x1 << 10) + 0xC,
  SHADER_STAGE_TESSELLATION_EVALUATION_13_SLOT_BIT = (0x1 << 10) + 0xD,
  SHADER_STAGE_TESSELLATION_EVALUATION_14_SLOT_BIT = (0x1 << 10) + 0xE,
  SHADER_STAGE_TESSELLATION_EVALUATION_15_SLOT_BIT = (0x1 << 10) + 0xF,
  SHADER_STAGE_TESSELLATION_EVALUATION_16_SLOT_BIT = (0x1 << 10) + 0x10,
  SHADER_STAGE_GEOMETRY_0_SLOT_BIT = (0x1 << 15) + 0x0,
  SHADER_STAGE_GEOMETRY_1_SLOT_BIT = (0x1 << 15) + 0x1,
  SHADER_STAGE_GEOMETRY_2_SLOT_BIT = (0x1 << 15) + 0x2,
  SHADER_STAGE_GEOMETRY_3_SLOT_BIT = (0x1 << 15) + 0x3,
  SHADER_STAGE_GEOMETRY_4_SLOT_BIT = (0x1 << 15) + 0x4,
  SHADER_STAGE_GEOMETRY_5_SLOT_BIT = (0x1 << 15) + 0x5,
  SHADER_STAGE_GEOMETRY_6_SLOT_BIT = (0x1 << 15) + 0x6,
  SHADER_STAGE_GEOMETRY_7_SLOT_BIT = (0x1 << 15) + 0x7,
  SHADER_STAGE_GEOMETRY_8_SLOT_BIT = (0x1 << 15) + 0x8,
  SHADER_STAGE_GEOMETRY_9_SLOT_BIT = (0x1 << 15) + 0x9,
  SHADER_STAGE_GEOMETRY_10_SLOT_BIT = (0x1 << 15) + 0xA,
  SHADER_STAGE_GEOMETRY_11_SLOT_BIT = (0x1 << 15) + 0xB,
  SHADER_STAGE_GEOMETRY_12_SLOT_BIT = (0x1 << 15) + 0xC,
  SHADER_STAGE_GEOMETRY_13_SLOT_BIT = (0x1 << 15) + 0xD,
  SHADER_STAGE_GEOMETRY_14_SLOT_BIT = (0x1 << 15) + 0xE,
  SHADER_STAGE_GEOMETRY_15_SLOT_BIT = (0x1 << 15) + 0xF,
  SHADER_STAGE_GEOMETRY_16_SLOT_BIT = (0x1 << 15) + 0x10,
  SHADER_STAGE_FRAGMENT_0_SLOT_BIT = (0x1 << 20) + 0x0,
  SHADER_STAGE_FRAGMENT_1_SLOT_BIT = (0x1 << 20) + 0x1,
  SHADER_STAGE_FRAGMENT_2_SLOT_BIT = (0x1 << 20) + 0x2,
  SHADER_STAGE_FRAGMENT_3_SLOT_BIT = (0x1 << 20) + 0x3,
  SHADER_STAGE_FRAGMENT_4_SLOT_BIT = (0x1 << 20) + 0x4,
  SHADER_STAGE_FRAGMENT_5_SLOT_BIT = (0x1 << 20) + 0x5,
  SHADER_STAGE_FRAGMENT_6_SLOT_BIT = (0x1 << 20) + 0x6,
  SHADER_STAGE_FRAGMENT_7_SLOT_BIT = (0x1 << 20) + 0x7,
  SHADER_STAGE_FRAGMENT_8_SLOT_BIT = (0x1 << 20) + 0x8,
  SHADER_STAGE_FRAGMENT_9_SLOT_BIT = (0x1 << 20) + 0x9,
  SHADER_STAGE_FRAGMENT_10_SLOT_BIT = (0x1 << 20) + 0xA,
  SHADER_STAGE_FRAGMENT_11_SLOT_BIT = (0x1 << 20) + 0xB,
  SHADER_STAGE_FRAGMENT_12_SLOT_BIT = (0x1 << 20) + 0xC,
  SHADER_STAGE_FRAGMENT_13_SLOT_BIT = (0x1 << 20) + 0xD,
  SHADER_STAGE_FRAGMENT_14_SLOT_BIT = (0x1 << 20) + 0xE,
  SHADER_STAGE_FRAGMENT_15_SLOT_BIT = (0x1 << 20) + 0xF,
  SHADER_STAGE_FRAGMENT_16_SLOT_BIT = (0x1 << 20) + 0x10,
  ...
  SHADER_STAGE_CALLABLE_0_SLOT_BIT = SHADER_STAGE_ALL_GRAPHICS_0_SLOT_BIT,
  SHADER_STAGE_CALLABLE_1_SLOT_BIT = SHADER_STAGE_ALL_GRAPHICS_1_SLOT_BIT,
  SHADER_STAGE_CALLABLE_2_SLOT_BIT = SHADER_STAGE_ALL_GRAPHICS_2_SLOT_BIT,
  SHADER_STAGE_CALLABLE_3_SLOT_BIT = SHADER_STAGE_ALL_GRAPHICS_3_SLOT_BIT,
  SHADER_STAGE_CALLABLE_4_SLOT_BIT = SHADER_STAGE_ALL_GRAPHICS_4_SLOT_BIT,
  SHADER_STAGE_CALLABLE_5_SLOT_BIT = SHADER_STAGE_ALL_GRAPHICS_5_SLOT_BIT,
  SHADER_STAGE_CALLABLE_6_SLOT_BIT = SHADER_STAGE_ALL_GRAPHICS_6_SLOT_BIT,
  SHADER_STAGE_CALLABLE_7_SLOT_BIT = SHADER_STAGE_ALL_GRAPHICS_7_SLOT_BIT,
  SHADER_STAGE_CALLABLE_8_SLOT_BIT = SHADER_STAGE_ALL_GRAPHICS_8_SLOT_BIT,
  SHADER_STAGE_CALLABLE_9_SLOT_BIT = SHADER_STAGE_ALL_GRAPHICS_9_SLOT_BIT,
  SHADER_STAGE_CALLABLE_10_SLOT_BIT = SHADER_STAGE_ALL_GRAPHICS_10_SLOT_BIT,
  SHADER_STAGE_CALLABLE_11_SLOT_BIT = SHADER_STAGE_ALL_GRAPHICS_11_SLOT_BIT,
  SHADER_STAGE_CALLABLE_12_SLOT_BIT = SHADER_STAGE_ALL_GRAPHICS_12_SLOT_BIT,
  SHADER_STAGE_CALLABLE_13_SLOT_BIT = SHADER_STAGE_ALL_GRAPHICS_13_SLOT_BIT,
  SHADER_STAGE_CALLABLE_14_SLOT_BIT = SHADER_STAGE_ALL_GRAPHICS_14_SLOT_BIT,
  SHADER_STAGE_CALLABLE_15_SLOT_BIT = SHADER_STAGE_ALL_GRAPHICS_15_SLOT_BIT,
  SHADER_STAGE_CALLABLE_16_SLOT_BIT = SHADER_STAGE_ALL_GRAPHICS_16_SLOT_BIT,
  SHADER_STAGE_TASK_0_SLOT_BIT = (0x1 << 25) + 0x0,
  SHADER_STAGE_TASK_1_SLOT_BIT = (0x1 << 25) + 0x1,
  SHADER_STAGE_TASK_2_SLOT_BIT = (0x1 << 25) + 0x2,
  SHADER_STAGE_TASK_3_SLOT_BIT = (0x1 << 25) + 0x3,
  SHADER_STAGE_TASK_4_SLOT_BIT = (0x1 << 25) + 0x4,
  SHADER_STAGE_TASK_5_SLOT_BIT = (0x1 << 25) + 0x5,
  SHADER_STAGE_TASK_6_SLOT_BIT = (0x1 << 25) + 0x6,
  SHADER_STAGE_TASK_7_SLOT_BIT = (0x1 << 25) + 0x7,
  SHADER_STAGE_TASK_8_SLOT_BIT = (0x1 << 25) + 0x8,
  SHADER_STAGE_TASK_9_SLOT_BIT = (0x1 << 25) + 0x9,
  SHADER_STAGE_TASK_10_SLOT_BIT = (0x1 << 25) + 0xA,
  SHADER_STAGE_TASK_11_SLOT_BIT = (0x1 << 25) + 0xB,
  SHADER_STAGE_TASK_12_SLOT_BIT = (0x1 << 25) + 0xC,
  SHADER_STAGE_TASK_13_SLOT_BIT = (0x1 << 25) + 0xD,
  SHADER_STAGE_TASK_14_SLOT_BIT = (0x1 << 25) + 0xE,
  SHADER_STAGE_TASK_15_SLOT_BIT = (0x1 << 25) + 0xF,
  SHADER_STAGE_TASK_16_SLOT_BIT = (0x1 << 25) + 0x10,
  SHADER_STAGE_MESH_0_SLOT_BIT = (0x1 << 30) + 0x0,
  SHADER_STAGE_MESH_1_SLOT_BIT = (0x1 << 30) + 0x1,
  SHADER_STAGE_MESH_2_SLOT_BIT = (0x1 << 30) + 0x2,
  SHADER_STAGE_MESH_3_SLOT_BIT = (0x1 << 30) + 0x3,
  SHADER_STAGE_MESH_4_SLOT_BIT = (0x1 << 30) + 0x4,
  SHADER_STAGE_MESH_5_SLOT_BIT = (0x1 << 30) + 0x5,
  SHADER_STAGE_MESH_6_SLOT_BIT = (0x1 << 30) + 0x6,
  SHADER_STAGE_MESH_7_SLOT_BIT = (0x1 << 30) + 0x7,
  SHADER_STAGE_MESH_8_SLOT_BIT = (0x1 << 30) + 0x8,
  SHADER_STAGE_MESH_9_SLOT_BIT = (0x1 << 30) + 0x9,
  SHADER_STAGE_MESH_10_SLOT_BIT = (0x1 << 30) + 0xA,
  SHADER_STAGE_MESH_11_SLOT_BIT = (0x1 << 30) + 0xB,
  SHADER_STAGE_MESH_12_SLOT_BIT = (0x1 << 30) + 0xC,
  SHADER_STAGE_MESH_13_SLOT_BIT = (0x1 << 30) + 0xD,
  SHADER_STAGE_MESH_14_SLOT_BIT = (0x1 << 30) + 0xE,
  SHADER_STAGE_MESH_15_SLOT_BIT = (0x1 << 30) + 0xF,
  SHADER_STAGE_MESH_16_SLOT_BIT = (0x1 << 30) + 0x10,
  SHADER_STAGE_SUBPASS_SHADING_0_SLOT_BIT =
      (static_cast<std::uint64_t>(0x1) << 35) + 0x0,
  SHADER_STAGE_SUBPASS_SHADING_1_SLOT_BIT =
      (static_cast<std::uint64_t>(0x1) << 35) + 0x1,
  SHADER_STAGE_SUBPASS_SHADING_2_SLOT_BIT =
      (static_cast<std::uint64_t>(0x1) << 35) + 0x2,
  SHADER_STAGE_SUBPASS_SHADING_3_SLOT_BIT =
      (static_cast<std::uint64_t>(0x1) << 35) + 0x3,
  SHADER_STAGE_SUBPASS_SHADING_4_SLOT_BIT =
      (static_cast<std::uint64_t>(0x1) << 35) + 0x4,
  SHADER_STAGE_SUBPASS_SHADING_5_SLOT_BIT =
      (static_cast<std::uint64_t>(0x1) << 35) + 0x5,
  SHADER_STAGE_SUBPASS_SHADING_6_SLOT_BIT =
      (static_cast<std::uint64_t>(0x1) << 35) + 0x6,
  SHADER_STAGE_SUBPASS_SHADING_7_SLOT_BIT =
      (static_cast<std::uint64_t>(0x1) << 35) + 0x7,
  SHADER_STAGE_SUBPASS_SHADING_8_SLOT_BIT =
      (static_cast<std::uint64_t>(0x1) << 35) + 0x8,
  SHADER_STAGE_SUBPASS_SHADING_9_SLOT_BIT =
      (static_cast<std::uint64_t>(0x1) << 35) + 0x9,
  SHADER_STAGE_SUBPASS_SHADING_10_SLOT_BIT =
      (static_cast<std::uint64_t>(0x1) << 35) + 0xA,
  SHADER_STAGE_SUBPASS_SHADING_11_SLOT_BIT =
      (static_cast<std::uint64_t>(0x1) << 35) + 0xB,
  SHADER_STAGE_SUBPASS_SHADING_12_SLOT_BIT =
      (static_cast<std::uint64_t>(0x1) << 35) + 0xC,
  SHADER_STAGE_SUBPASS_SHADING_13_SLOT_BIT =
      (static_cast<std::uint64_t>(0x1) << 35) + 0xD,
  SHADER_STAGE_SUBPASS_SHADING_14_SLOT_BIT =
      (static_cast<std::uint64_t>(0x1) << 35) + 0xE,
  SHADER_STAGE_SUBPASS_SHADING_15_SLOT_BIT =
      (static_cast<std::uint64_t>(0x1) << 35) + 0xF,
  SHADER_STAGE_SUBPASS_SHADING_16_SLOT_BIT =
      (static_cast<std::uint64_t>(0x1) << 35) + 0x10,

  // All stage
  SHADER_STAGE_ALL_STAGE_0_SLOT_BIT =
      SHADER_STAGE_ALL_GRAPHICS_0_SLOT_BIT + SHADER_STAGE_RAYGEN_0_SLOT_BIT +
      SHADER_STAGE_ANY_HIT_0_SLOT_BIT + SHADER_STAGE_CLOSEST_0_SLOT_BIT +
      SHADER_STAGE_MISS_0_SLOT_BIT + SHADER_STAGE_INTERSECTION_0_SLOT_BIT +
      SHADER_STAGE_CALLABLE_0_SLOT_BIT + SHADER_STAGE_TASK_0_SLOT_BIT +
      SHADER_STAGE_MESH_0_SLOT_BIT + SHADER_STAGE_SUBPASS_SHADING_0_SLOT_BIT,
  SHADER_STAGE_ALL_STAGE_1_SLOT_BIT =
      SHADER_STAGE_ALL_GRAPHICS_1_SLOT_BIT + SHADER_STAGE_RAYGEN_1_SLOT_BIT +
      SHADER_STAGE_ANY_HIT_1_SLOT_BIT + SHADER_STAGE_CLOSEST_1_SLOT_BIT +
      SHADER_STAGE_MISS_1_SLOT_BIT + SHADER_STAGE_INTERSECTION_1_SLOT_BIT +
      SHADER_STAGE_CALLABLE_1_SLOT_BIT + SHADER_STAGE_TASK_1_SLOT_BIT +
      SHADER_STAGE_MESH_1_SLOT_BIT + SHADER_STAGE_SUBPASS_SHADING_1_SLOT_BIT,
  SHADER_STAGE_ALL_STAGE_2_SLOT_BIT =
      SHADER_STAGE_ALL_GRAPHICS_2_SLOT_BIT + SHADER_STAGE_RAYGEN_2_SLOT_BIT +
      SHADER_STAGE_ANY_HIT_2_SLOT_BIT + SHADER_STAGE_CLOSEST_2_SLOT_BIT +
      SHADER_STAGE_MISS_2_SLOT_BIT + SHADER_STAGE_INTERSECTION_2_SLOT_BIT +
      SHADER_STAGE_CALLABLE_2_SLOT_BIT + SHADER_STAGE_TASK_2_SLOT_BIT +
      SHADER_STAGE_MESH_2_SLOT_BIT + SHADER_STAGE_SUBPASS_SHADING_2_SLOT_BIT,
  SHADER_STAGE_ALL_STAGE_3_SLOT_BIT =
      SHADER_STAGE_ALL_GRAPHICS_3_SLOT_BIT + SHADER_STAGE_RAYGEN_3_SLOT_BIT +
      SHADER_STAGE_ANY_HIT_3_SLOT_BIT + SHADER_STAGE_CLOSEST_3_SLOT_BIT +
      SHADER_STAGE_MISS_3_SLOT_BIT + SHADER_STAGE_INTERSECTION_3_SLOT_BIT +
      SHADER_STAGE_CALLABLE_3_SLOT_BIT + SHADER_STAGE_TASK_3_SLOT_BIT +
      SHADER_STAGE_MESH_3_SLOT_BIT + SHADER_STAGE_SUBPASS_SHADING_3_SLOT_BIT,
  SHADER_STAGE_ALL_STAGE_4_SLOT_BIT =
      SHADER_STAGE_ALL_GRAPHICS_4_SLOT_BIT + SHADER_STAGE_RAYGEN_4_SLOT_BIT +
      SHADER_STAGE_ANY_HIT_4_SLOT_BIT + SHADER_STAGE_CLOSEST_4_SLOT_BIT +
      SHADER_STAGE_MISS_4_SLOT_BIT + SHADER_STAGE_INTERSECTION_4_SLOT_BIT +
      SHADER_STAGE_CALLABLE_4_SLOT_BIT + SHADER_STAGE_TASK_4_SLOT_BIT +
      SHADER_STAGE_MESH_4_SLOT_BIT + SHADER_STAGE_SUBPASS_SHADING_4_SLOT_BIT,
  SHADER_STAGE_ALL_STAGE_5_SLOT_BIT =
      SHADER_STAGE_ALL_GRAPHICS_5_SLOT_BIT + SHADER_STAGE_RAYGEN_5_SLOT_BIT +
      SHADER_STAGE_ANY_HIT_5_SLOT_BIT + SHADER_STAGE_CLOSEST_5_SLOT_BIT +
      SHADER_STAGE_MISS_5_SLOT_BIT + SHADER_STAGE_INTERSECTION_5_SLOT_BIT +
      SHADER_STAGE_CALLABLE_5_SLOT_BIT + SHADER_STAGE_TASK_5_SLOT_BIT +
      SHADER_STAGE_MESH_5_SLOT_BIT + SHADER_STAGE_SUBPASS_SHADING_5_SLOT_BIT,
  SHADER_STAGE_ALL_STAGE_6_SLOT_BIT =
      SHADER_STAGE_ALL_GRAPHICS_6_SLOT_BIT + SHADER_STAGE_RAYGEN_6_SLOT_BIT +
      SHADER_STAGE_ANY_HIT_6_SLOT_BIT + SHADER_STAGE_CLOSEST_6_SLOT_BIT +
      SHADER_STAGE_MISS_6_SLOT_BIT + SHADER_STAGE_INTERSECTION_6_SLOT_BIT +
      SHADER_STAGE_CALLABLE_6_SLOT_BIT + SHADER_STAGE_TASK_6_SLOT_BIT +
      SHADER_STAGE_MESH_6_SLOT_BIT + SHADER_STAGE_SUBPASS_SHADING_6_SLOT_BIT,
  SHADER_STAGE_ALL_STAGE_7_SLOT_BIT =
      SHADER_STAGE_ALL_GRAPHICS_7_SLOT_BIT + SHADER_STAGE_RAYGEN_7_SLOT_BIT +
      SHADER_STAGE_ANY_HIT_7_SLOT_BIT + SHADER_STAGE_CLOSEST_7_SLOT_BIT +
      SHADER_STAGE_MISS_7_SLOT_BIT + SHADER_STAGE_INTERSECTION_7_SLOT_BIT +
      SHADER_STAGE_CALLABLE_7_SLOT_BIT + SHADER_STAGE_TASK_7_SLOT_BIT +
      SHADER_STAGE_MESH_7_SLOT_BIT + SHADER_STAGE_SUBPASS_SHADING_7_SLOT_BIT,
  SHADER_STAGE_ALL_STAGE_8_SLOT_BIT =
      SHADER_STAGE_ALL_GRAPHICS_8_SLOT_BIT + SHADER_STAGE_RAYGEN_8_SLOT_BIT +
      SHADER_STAGE_ANY_HIT_8_SLOT_BIT + SHADER_STAGE_CLOSEST_8_SLOT_BIT +
      SHADER_STAGE_MISS_8_SLOT_BIT + SHADER_STAGE_INTERSECTION_8_SLOT_BIT +
      SHADER_STAGE_CALLABLE_8_SLOT_BIT + SHADER_STAGE_TASK_8_SLOT_BIT +
      SHADER_STAGE_MESH_8_SLOT_BIT + SHADER_STAGE_SUBPASS_SHADING_8_SLOT_BIT,
  SHADER_STAGE_ALL_STAGE_9_SLOT_BIT =
      SHADER_STAGE_ALL_GRAPHICS_9_SLOT_BIT + SHADER_STAGE_RAYGEN_9_SLOT_BIT +
      SHADER_STAGE_ANY_HIT_9_SLOT_BIT + SHADER_STAGE_CLOSEST_9_SLOT_BIT +
      SHADER_STAGE_MISS_9_SLOT_BIT + SHADER_STAGE_INTERSECTION_9_SLOT_BIT +
      SHADER_STAGE_CALLABLE_9_SLOT_BIT + SHADER_STAGE_TASK_9_SLOT_BIT +
      SHADER_STAGE_MESH_9_SLOT_BIT + SHADER_STAGE_SUBPASS_SHADING_9_SLOT_BIT,
  SHADER_STAGE_ALL_STAGE_10_SLOT_BIT =
      SHADER_STAGE_ALL_GRAPHICS_10_SLOT_BIT + SHADER_STAGE_RAYGEN_10_SLOT_BIT +
      SHADER_STAGE_ANY_HIT_10_SLOT_BIT + SHADER_STAGE_CLOSEST_10_SLOT_BIT +
      SHADER_STAGE_MISS_10_SLOT_BIT + SHADER_STAGE_INTERSECTION_10_SLOT_BIT +
      SHADER_STAGE_CALLABLE_10_SLOT_BIT + SHADER_STAGE_TASK_10_SLOT_BIT +
      SHADER_STAGE_MESH_10_SLOT_BIT + SHADER_STAGE_SUBPASS_SHADING_10_SLOT_BIT,
  SHADER_STAGE_ALL_STAGE_11_SLOT_BIT =
      SHADER_STAGE_ALL_GRAPHICS_11_SLOT_BIT + SHADER_STAGE_RAYGEN_11_SLOT_BIT +
      SHADER_STAGE_ANY_HIT_11_SLOT_BIT + SHADER_STAGE_CLOSEST_11_SLOT_BIT +
      SHADER_STAGE_MISS_11_SLOT_BIT + SHADER_STAGE_INTERSECTION_11_SLOT_BIT +
      SHADER_STAGE_CALLABLE_11_SLOT_BIT + SHADER_STAGE_TASK_11_SLOT_BIT +
      SHADER_STAGE_MESH_11_SLOT_BIT + SHADER_STAGE_SUBPASS_SHADING_11_SLOT_BIT,
  SHADER_STAGE_ALL_STAGE_12_SLOT_BIT =
      SHADER_STAGE_ALL_GRAPHICS_12_SLOT_BIT + SHADER_STAGE_RAYGEN_12_SLOT_BIT +
      SHADER_STAGE_ANY_HIT_12_SLOT_BIT + SHADER_STAGE_CLOSEST_12_SLOT_BIT +
      SHADER_STAGE_MISS_12_SLOT_BIT + SHADER_STAGE_INTERSECTION_12_SLOT_BIT +
      SHADER_STAGE_CALLABLE_12_SLOT_BIT + SHADER_STAGE_TASK_12_SLOT_BIT +
      SHADER_STAGE_MESH_12_SLOT_BIT + SHADER_STAGE_SUBPASS_SHADING_12_SLOT_BIT,
  SHADER_STAGE_ALL_STAGE_13_SLOT_BIT =
      SHADER_STAGE_ALL_GRAPHICS_13_SLOT_BIT + SHADER_STAGE_RAYGEN_13_SLOT_BIT +
      SHADER_STAGE_ANY_HIT_13_SLOT_BIT + SHADER_STAGE_CLOSEST_13_SLOT_BIT +
      SHADER_STAGE_MISS_13_SLOT_BIT + SHADER_STAGE_INTERSECTION_13_SLOT_BIT +
      SHADER_STAGE_CALLABLE_13_SLOT_BIT + SHADER_STAGE_TASK_13_SLOT_BIT +
      SHADER_STAGE_MESH_13_SLOT_BIT + SHADER_STAGE_SUBPASS_SHADING_13_SLOT_BIT,
  SHADER_STAGE_ALL_STAGE_14_SLOT_BIT =
      SHADER_STAGE_ALL_GRAPHICS_14_SLOT_BIT + SHADER_STAGE_RAYGEN_14_SLOT_BIT +
      SHADER_STAGE_ANY_HIT_14_SLOT_BIT + SHADER_STAGE_CLOSEST_14_SLOT_BIT +
      SHADER_STAGE_MISS_14_SLOT_BIT + SHADER_STAGE_INTERSECTION_14_SLOT_BIT +
      SHADER_STAGE_CALLABLE_14_SLOT_BIT + SHADER_STAGE_TASK_14_SLOT_BIT +
      SHADER_STAGE_MESH_14_SLOT_BIT + SHADER_STAGE_SUBPASS_SHADING_14_SLOT_BIT,
  SHADER_STAGE_ALL_STAGE_15_SLOT_BIT =
      SHADER_STAGE_ALL_GRAPHICS_15_SLOT_BIT + SHADER_STAGE_RAYGEN_15_SLOT_BIT +
      SHADER_STAGE_ANY_HIT_15_SLOT_BIT + SHADER_STAGE_CLOSEST_15_SLOT_BIT +
      SHADER_STAGE_MISS_15_SLOT_BIT + SHADER_STAGE_INTERSECTION_15_SLOT_BIT +
      SHADER_STAGE_CALLABLE_15_SLOT_BIT + SHADER_STAGE_TASK_15_SLOT_BIT +
      SHADER_STAGE_MESH_15_SLOT_BIT + SHADER_STAGE_SUBPASS_SHADING_15_SLOT_BIT,
  SHADER_STAGE_ALL_STAGE_16_SLOT_BIT =
      SHADER_STAGE_ALL_GRAPHICS_16_SLOT_BIT + SHADER_STAGE_RAYGEN_16_SLOT_BIT +
      SHADER_STAGE_ANY_HIT_16_SLOT_BIT + SHADER_STAGE_CLOSEST_16_SLOT_BIT +
      SHADER_STAGE_MISS_16_SLOT_BIT + SHADER_STAGE_INTERSECTION_16_SLOT_BIT +
      SHADER_STAGE_CALLABLE_16_SLOT_BIT + SHADER_STAGE_TASK_16_SLOT_BIT +
      SHADER_STAGE_MESH_16_SLOT_BIT + SHADER_STAGE_SUBPASS_SHADING_16_SLOT_BIT,
};
}  // namespace RenderSystem
}  // namespace MM