...
class RenderBufferManager : public Manager::ManagerBase<AllocatorBuffer> {
 public:
 ...
 public:
  RenderBufferManager(const RenderBufferManager& other) = delete;
  RenderBufferManager(RenderBufferManager&& other) noexcept = delete;
  RenderBufferManager& operator=(const RenderBufferManager& other) = delete;
  RenderBufferManager& operator=(RenderBufferManager&& other) noexcept = delete;
 ...
 protected:
  ...
  explicit RenderBufferManager(std::uint64_t size);
 ...
 protected:
  static RenderBufferManager* render_resource_manager_;
